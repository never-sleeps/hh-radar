...
- [ ] Возможно, стоит убрать подробный вывод вакансий, оставив только их обновление и ссылки на них
- [ ] РЕФАКТОРИНГ (разобраться с передачей Update)
- [ ] РЕФАКТОРИНГ (сделать отдельный MenuServise)
- [ ] РЕФАКТОРИНГ. Отрефакторить Utils (куда-то вынести ru.hh.radar.service.Utils.getAuthorizationHttpHeader)
- [ ] РЕФАКТОРИНГ. Переименовать ru.hh.radar.telegram.service.TelegramService (на деле он для работы с Update)
